		...
		<div className={layoutClasses.container}>
			...
			<div className={layoutClasses.addBox} onClick={() => setShowModal(true)}>
				<div className="flex items-center justify-center gap-3 text-gray-500 group-hover:text-purple-600 transition-colors">
					<div className="w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:shadow-sm transition-all duration-200">
				...
				{sortedPendingTasks.length === 0 ? (
					...
					sortedPendingTasks.map((task) => (
						<TaskItem
							...
							onToggleComplete={() =>
								handleToggleComplete(task.id || task._id, t.completed)
							}
							onEdit={() => {
